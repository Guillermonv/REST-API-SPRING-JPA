...
import com.crossover.techtrial.service.DailyElectricityServiceImpl;
...
//  DailyElectricityService dailyElectricityService;
  ...
  public ResponseEntity<?> saveHourlyElectricity(
    ...
    hourlyElectricity.setId(panel.getId());
  ...
  public ResponseEntity<List<DailyElectricity>> allDailyElectricityFromYesterday(
    ...
    dailyElectricityForPanel = dailyElectricityService.allDailyElectricityFromYesterday(panel.getId());
